...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sleon-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sleon"
  #   chef.validation_client_name = "sleon-validator"
  #   chef.validation_key_path = ".chef/sleon-validator.pem"
  # end
end
